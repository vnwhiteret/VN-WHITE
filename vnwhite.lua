-- ============================================================
-- VNWHITE - MAIN (com name changer avançado)
-- ============================================================
...
local M = load(GUILIB_URL, ".\\vnwhite_lua\\vnwhite_guilib.lua", "guilib")
if type(M) ~= "table" then return end

local C = load(CHANGER_URL, ".\\vnwhite_lua\\vnwhite_changer.lua", "changer")
...
do
    ...
    local function pfx() return "[" .. P .. "vnwhite" .. W .. "] " end  -- ALTERADO PARA vnwhite
...
pcall(function()
    ...
    callbacks.Register("FireGameEvent", "VNWhite_Events", function(ev)  -- Nome do evento alterado
        pcall(HS.onEvent, ev)
        pcall(VR.onEvent, ev)
    end)
end)
...
-- ============================================================
-- FUNÇÕES GERADORAS DE SEQUÊNCIAS PARA NAME CHANGER
-- ============================================================
...
-- ============================================================
-- DEFINIÇÃO DAS SEQUÊNCIAS PARA O NAME CHANGER
-- ============================================================
...
ncSrc    = ncSec:Combo("Source", { "Static", "VNWHITE", "Discord", "Custom" }, 1)  -- Nomes atualizados
